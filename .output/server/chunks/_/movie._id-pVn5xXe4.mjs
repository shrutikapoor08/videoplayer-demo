...
const E = (i) => {
  ...
  let o;
  r[0] === Symbol.for("react.memo_cache_sentinel") ? (o = jsx("h1", { className: "text-2xl font-bold text-red-500 mb-4", children: "Error Loading Movie" }), r[0] = o) : o = r[0];
  let t;
...
//# sourceMappingURL=movie._id-pVn5xXe4.mjs.map
